  ...
  return (
    <>
      <div className="flex justify-center flex-col-reverse top-10 sm:flex-row max-sm:items-center mt-[20%] md:mt-[15%] lg:mt-[10%] xl:mt-[8%] space-x-24">
        <div className="h-100 w-[30%] max-sm:w-[50%] rounded-4xl pl-10 md:mt-10 max-sm:mt-5 z-10">
          <div className="mt-10">
          ...
          <div className="mt-5">
            <button 
              ...
              className="bg-purple-700 hover:bg-purple-800 text-white border-2 border-white h-10 w-30 xl:h-15 xl:w-35 font-extrabold rounded-full text-center cursor-pointer transition-all duration-200"
            >
