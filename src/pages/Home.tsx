...
const Home = () => {
  return (
    <div className="flex justify-center flex-col-reverse sm:flex-row max-sm:items-center mt-[20%] md:mt-[15%] lg:mt-[10%] xl:mt-[8%] space-x-24">
      <div className="h-100 w-[30%] rounded-4xl pt-10">
        ...
        <div className="mt-5 flex gap-3">
          ...
          <div className="h-10 w-10 xl:h-15 xl:w-15 border-2 border-white bg-purple-700 rounded-full"><a href="https://www.linkedin.com/in/manojkumar-a-0b05382b0/"><FaLinkedinIn className="text-white font-extrabold h-6 w-7 ml-1 mt-1.5 xl:h-9 xl:w-10 xl:ml-2 xl:mt-2.5"/></a></div>
      ...
      <div className="relative h-70 w-70 sm:h-80 sm:w-80 md:h-90 md:w-90 lg:h-100 lg:w-100 xl:w-110 xl:h-110 rounded-full">
        ...
        <img src={Image1} alt="" className="absolute rounded-full h-70 w-70 sm:h-80 sm:w-80 md:w-90 md:h-90 lg:w-100 lg:h-100 xl:w-110 xl:h-110 border-4 border-purple-600 object-cover"/>
      </div>
    </div>
  );
};
